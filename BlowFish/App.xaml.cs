...
{
    /// <summary>
    ///     Логика работы алгоритма шифрования Blowfish
    /// </summary>
    public class Blowfish
    {
        ...
        //раундовые ключи основанные на числе PI
        ...
        /// <summary>
        ///     Конструктор с заданным ключом (массивом)
        /// </summary>
        /// <param name="key">Ключ для шифрования</param>
        private Blowfish(byte[] key)
        {
            _p = P.Clone() as uint[];
            _s = S.Clone() as uint[,];
            ...
            for (short i = 0; i < N + 2; ++i)
            {
                ...
                if (_p != null) _p[i] ^= data;
            }

            uint left = 0x00000000;
            uint right = 0x00000000;
        ...
        /// <summary>
        ///     Конструктор с заданным ключом (строкой)
        /// </summary>
        /// <param name="key">Ключ для шифрования</param>
        ...
        /// <summary>
        ///     Ячейка Фейстеля для реализации функции Фейстеля
        /// </summary>
        private uint F(uint x)
        {
            ...
            /*Общий вид действия: y = ((S[0][a] + S[1][b]) ^ S[2][c]) + S[3][d];*/
            var y = _s[0, a] + _s[1, b];
            y ^= _s[2, c];
            y += _s[3, d];
            return y;
        ...
        private void Encipher(byte[] data)
        {
            ...
            {
                //Шифрование элементов в 8-ых битных блоках
        ...
        /// <summary>
        ///     Функция шифрования отдельного блока
        /// </summary>
        /// <param name="xl">Левая часть 8-ми байт</param>
        /// <param name="xr">Правая часть 8-ми байт</param>
        ...
        /// <summary>
        ///     Функция дешифрования массива
        /// </summary>
        /// <param name="data">Массив для дешифрования</param>
        private void Decipher(byte[] data)
        {
            int length = data.Length;
            if (length % 8 != 0)
                throw new Exception("Invalid length");
        ...
        /// <summary>
        ///     Функция дешифрования отдельного блока
        /// </summary>
        /// <param name="xl">Левая часть 8-ми байт</param>
        /// <param name="xr">Правая часть 8-ми байт</param>
        ...
        /// </summary>
        /// <param name="data">Строка для дешифрования</param>
